...
export const FIRMS: Firm[] = [
  {
    ...
    blocks: [
      { kind: 'callout', tone: 'new', title: '✅ 依官方 Help Center 核對（2026/07）', body: '官方目前仍載明 LucidPro 考試有日風控（50K $1,200／100K $1,800／150K $2,700，25K 無）。部分中文站流傳「7/5 起 Pro 取消 DLL」，官方文件未見此變更，請以官網購買頁為準。Lucid 所有 DLL 皆為軟違規：碰到只當日禁交易，不會直接失去帳號（除非碰到最大虧損 MLL）。' },
      ...
      { kind: 'list', items: [
        'Pro：考試有固定 DLL（50K $1,200／100K $1,800／150K $2,700；25K 無），出金 40% 一致性＋緩衝區（緩衝＝總風控＋$100）。40% 僅適用 2025/11/28 後購買/重置，之前為 35%；Live 後無一致性。',
